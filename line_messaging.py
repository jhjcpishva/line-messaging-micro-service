    ...
    def push_audio_message(self, to: str, text: str = None, audio_url: str = None, audio_length=None) -> PushMessageResponse:
        ...
        if audio_url is not None:
            if audio_length is None:
                raise ValueError(
                    "Audio length must be provided when audio URL is given")
            messages.append(AudioMessage(
                originalContentUrl=audio_url, duration=audio_length))
    ...
    def push_image_message(self, to: str, text: str = None, image_url: str = None) -> PushMessageResponse:
        ...
        if image_url is not None:
            messages.append(ImageMessage(
                originalContentUrl=image_url, previewImageUrl=image_url))
